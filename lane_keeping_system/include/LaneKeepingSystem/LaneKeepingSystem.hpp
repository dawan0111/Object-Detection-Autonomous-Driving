...
{
public:
    using DetectBoxs = std::priority_queue<std::pair<int32_t, std::tuple<int16_t, PREC, PREC, PREC, PREC, ros::Time>>>;
    ...
    using TrafficLightColorPtr = typename GetTrafficLightColor<PREC>::Ptr;
...
private:
    ...
    StanleyPtr mStanley;
    TrafficLightColorPtr mTrafficLightColorDetector;
